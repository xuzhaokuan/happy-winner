...
.btns a:nth-of-type(1) i {
    ...
    pointer-events: none;
        display: inline-block;
   background: url(https://s2.music.126.net/style/web2/img/button2.png?3df6a3e3dc24e5c18b3d7dbce198a783) no-repeat 0 9999px;
    height: 31px;
    line-height: 31px;
    overflow: hidden;
    font-style: normal;
